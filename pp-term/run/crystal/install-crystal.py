...
print("""
WARNING: It is recommended to install Crystal from the official website:
https://crystal-lang.org/install/

This script is unofficial and may pose security risks.
Use at your own risk!

Do you really want to proceed with the Crystal installation? [y/n]:
""", end='')
...
# Hier kann der Installationscode für Crystal folgen
print(f"[{timestamp()}] [INFO] Proceeding with Crystal installation...")
