...
print("""
WARNING: It is recommended to install Ruby from the official website:
https://www.ruby-lang.org/en/downloads/

This script is unofficial and may pose security risks.
Use at your own risk!

Do you really want to proceed with the installation of Ruby? [y/n]:
""", end='')
...
# Hier kann der Installationscode für Ruby folgen
print(f"[{timestamp()}] [INFO] Proceeding with Ruby installation...")
...
logging.basicConfig(
    ...
    datefmt="%Y-%m-%d %H:%M:%S",
    handlers=[
        logging.FileHandler(glog_path, encoding='utf-8'),
...
def main():
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        installer_file = Path(tmpdir) / asset['name']
        download_installer(asset['url'], installer_file)
