...
print("""
WARNING: It is recommended to install Kotlin from the official website:
...
Do you really want to proceed with the installation of Kotlin? [y/n]:
""", end='')
...
# Hier kann der Installationscode für Kotlin folgen
print(f"[{timestamp()}] [INFO] Proceeding with Kotlin installation...")
