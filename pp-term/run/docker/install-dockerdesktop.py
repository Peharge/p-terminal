...
print("""
WARNING: It is recommended to install Docker from the official website:
https://docs.docker.com/get-docker/

This script is unofficial and may pose security risks.
Use at your own risk!

Do you really want to proceed with the installation of Docker? [y/n]:
""", end='')
...
# Hier kann der Installationscode für Docker folgen
print(f"[{timestamp()}] [INFO] Proceeding with Docker installation...")
...
def is_github_desktop_installed() -> bool:
    """Checks if GitHub Desktop is available via registry entry or PATH."""
    # GitHub Desktop installs a shortcut 'GitHubDesktop.exe' in the Program Files directory
...
def download_installer(dest_path: Path) -> None:
    """Downloads the GitHub Desktop Windows setup."""
...
def run_installer(installer_path: Path) -> None:
    ...
    logging.info(f"Starting GitHub Desktop Installer: {installer_path}")
    # Squirrel-based installer supports the '--silent' flag
...
def ensure_installed():
    """Finally checks whether GitHub Desktop is now available."""
...
def main():
    ...
    if is_github_desktop_installed():
        logging.info("GitHub Desktop is already installed. Aborting.")
        return
