...
print("""
WARNING: It is recommended to install Carban only from the official source:
https://official.carban.site/download

This script is unofficial and may pose security risks.
Use at your own risk!

Do you really want to proceed with the Carban installation? [y/n]:
""", end='')
...
# Hier kann der Installationscode für Carban folgen
print(f"[{timestamp()}] [INFO] Proceeding with Carban installation...")
