...
print(f"\n[{timestamp()}] [INFO] All frameworks for {main_color}SIMON{reset} are currently being installed and updated.")

# Paketlisten
packages = [
    "monai", "monailabel", "monai-deploy-app-sdk", "jupyter", "jupyterlab", "torch",
    "torchvision", "torchaudio", "nibabel", "SimpleITK", "medpy", "opencv-python",
    "tensorboard", "wandb", "pydicom"
]
