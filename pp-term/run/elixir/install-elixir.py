...
print("""
WARNING: It is recommended to install Elixir from the official website:
https://elixir-lang.org/install.html

This script is unofficial and may pose security risks.
Use at your own risk!

Do you really want to proceed with the installation of Elixir? [y/n]:
""", end='')
...
# Hier kann der Installationscode für Elixir folgen
print(f"[{timestamp()}] [INFO] Proceeding with Elixir installation...")
...
def main():
    ...
    install_dir = INSTALL_ROOT / f"elixir-{version}"

    with tempfile.TemporaryDirectory() as td:
        tmp_zip = Path(td) / filename
        download_zip(tmp_zip, url)
        extract_elixir(tmp_zip, install_dir)
