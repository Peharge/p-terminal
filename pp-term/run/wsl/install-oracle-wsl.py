...
def install_oracle_linux():
    """
    Starts the installation process for the Oracle Linux distribution via WSL.
    """
    run_command(["wsl", "--install", "-d", "OracleLinux"])
...
def main():
    ...
    logging.info("Starting Oracle Linux installation for WSL...")
    ...
    try:
        ...
        logging.info(
            "The Oracle Linux installation has started. A restart may be required for all changes to take effect.")
        logging.info(
            "Upon the first start of Oracle Linux, you will be prompted to create a username and password.")
    except Exception as e:
