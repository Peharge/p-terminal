...
print("""
WARNING: This script is intended for installing or maintaining Pengwin on WSL.

This script is unofficial and may pose security risks.
Use at your own risk!

Do you really want to proceed with WSL Pengwin installation/maintenance? [y/n]:
""", end='')
...
# Hier kann der Installations- oder Wartungscode für WSL Pengwin folgen
print(f"[{timestamp()}] [INFO] Proceeding with WSL Pengwin installation/maintenance...")
...
def install_pengwin():
    """
    Starts the installation process for the Pengwin distribution via WSL.
    """
    run_command(["wsl", "--install", "-d", "Pengwin"])
...
def main():
    ...
    logging.info("Starting Pengwin installation for WSL...")
    ...
    try:
        ...
        # Start the Pengwin installation
        install_pengwin()

        logging.info(
            "The Pengwin installation has started. A restart may be required for all changes to take effect.")
        logging.info(
            "Upon the first start of Pengwin, you will be prompted to create a username and password.")
    except Exception as e:
