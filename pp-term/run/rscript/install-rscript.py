...
print("""
WARNING: It is recommended to install R and Rscript from the official CRAN website:
https://cran.r-project.org/

This script is unofficial and may pose security risks.
Use at your own risk!

Do you really want to proceed with the installation of Rscript? [y/n]:
""", end='')
...
# Hier kann der Installationscode für Rscript folgen
print(f"[{timestamp()}] [INFO] Proceeding with Rscript installation...")
