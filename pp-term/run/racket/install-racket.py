...
print("""
WARNING: It is recommended to install Racket from the official website:
https://racket-lang.org/

This script is unofficial and may pose security risks.
Use at your own risk!

Do you really want to proceed with the installation of Racket? [y/n]:
""", end='')
...
# Hier kann der Installationscode für Racket folgen
print(f"[{timestamp()}] [INFO] Proceeding with Racket installation...")
