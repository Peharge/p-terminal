...
print("""
WARNING: It is recommended to install Node.js from the official website:
https://nodejs.org/en/download/

This script is unofficial and may pose security risks.
Use at your own risk!

Do you really want to proceed with the installation of Node.js? [y/n]:
""", end='')
...
# Hier kann der Installationscode für Node.js folgen
print(f"[{timestamp()}] [INFO] Proceeding with Node.js installation...")
