...
def install_oh_my_posh():
    ...
    try:
        ...
        subprocess.run(["winget", "install", "agnosterplus.OhMyPosh"], check=True)
...
def initialize_oh_my_posh():
    ...
    try:
        config_path = os.path.expanduser("~") + r"\AppData\Local\Programs\oh-my-posh\themes\agnosterplus.omp.json"
...
def upgrade_oh_my_posh():
    ...
    try:
        ...
        subprocess.run(["winget", "upgrade", "agnosterplus.OhMyPosh"], check=True)
