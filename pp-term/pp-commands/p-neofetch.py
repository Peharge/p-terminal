...
def get_system_info() -> dict:
    ...
    try:
        ...
        info['P-Terminal Version'] = system_info.get("P-Terminal Version", "unknown")
        info['PP-Terminal Version'] = system_info.get("PP-Terminal Version", "unknown")
        info['PP-Terminal Launcher Version'] = system_info.get("PP-Terminal Launcher Version", "unknown")
        info['Peharge Compiler Version'] = system_info.get("Peharge Compiler Version", "unknown")
        info['Peharge Kernel Version'] = system_info.get("Peharge Kernel Version", "unknown")
        info['IQ Kernel Version'] = system_info.get("IQ Kernel Version", "unknown")
        info['SIMON Version'] = system_info.get("SIMON Version", "unknown")
        info['P-Terminal License'] = system_info.get("P-Terminal License", "unknown")
